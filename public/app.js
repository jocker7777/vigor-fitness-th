...
const foodCategories=['ทั้งหมด','ข้าว แป้ง','โปรตีน','ผัก','ผลไม้','นมและไข่','อาหารไทย','เครื่องดื่ม'];
['ข้าว แป้ง','นมและไข่','โปรตีน','ผลไม้','นมและไข่','นมและไข่','ผัก','ข้าว แป้ง','โปรตีน','ผลไม้'].forEach((category,index)=>foods[index].category=category);
[
 ['ข้าวกล้อง 1 ทัพพี','ข้าว แป้ง',110,3,23,1,'🍚'],['ขนมปังโฮลวีต 1 แผ่น','ข้าว แป้ง',75,3,14,1,'🍞'],['มันหวานนึ่ง 100 กรัม','ข้าว แป้ง',90,2,21,0,'🍠'],['ข้าวโอ๊ต 40 กรัม','ข้าว แป้ง',150,5,27,3,'🥣'],['เส้นหมี่ข้าวกล้อง 1 จาน','ข้าว แป้ง',190,4,42,1,'🍜'],['ข้าวโพดต้ม 1 ฝัก','ข้าว แป้ง',120,4,26,2,'🌽'],['ฟักทองนึ่ง 100 กรัม','ข้าว แป้ง',45,1,11,0,'🎃'],['มันฝรั่งต้ม 100 กรัม','ข้าว แป้ง',87,2,20,0,'🥔'],
 ['อกไก่ต้ม 100 กรัม','โปรตีน',165,31,0,4,'🍗'],['ไข่ขาว 3 ฟอง','โปรตีน',51,11,1,0,'🥚'],['ไข่เจียว 1 ฟอง','นมและไข่',140,7,1,11,'🍳'],['หมูสันใน 100 กรัม','โปรตีน',143,26,0,4,'🥩'],['เนื้อวัวไม่ติดมัน 100 กรัม','โปรตีน',190,27,0,8,'🥩'],['ปลาทูน่าในน้ำแร่ 100 กรัม','โปรตีน',116,26,0,1,'🐟'],['แซลมอนย่าง 100 กรัม','โปรตีน',208,20,0,13,'🐟'],['กุ้งลวก 100 กรัม','โปรตีน',99,24,0,0,'🦐'],['เต้าหู้ขาว 100 กรัม','โปรตีน',76,8,2,4,'◻️'],['เทมเป้ 100 กรัม','โปรตีน',192,20,8,11,'🫘'],
 ['บรอกโคลีลวก 100 กรัม','ผัก',34,3,7,0,'🥦'],['ผักโขมลวก 100 กรัม','ผัก',23,3,4,0,'🥬'],['แครอต 100 กรัม','ผัก',41,1,10,0,'🥕'],['แตงกวา 100 กรัม','ผัก',15,1,4,0,'🥒'],['มะเขือเทศ 100 กรัม','ผัก',18,1,4,0,'🍅'],['เห็ดรวม 100 กรัม','ผัก',28,3,4,0,'🍄'],['กะหล่ำปลี 100 กรัม','ผัก',25,1,6,0,'🥬'],['ผักกาดหอม 100 กรัม','ผัก',15,1,3,0,'🥗'],['ถั่วฝักยาว 100 กรัม','ผัก',47,3,8,0,'🫛'],['อะโวคาโดครึ่งผล','ผัก',160,2,9,15,'🥑'],
 ['ส้ม 1 ผล','ผลไม้',62,1,15,0,'🍊'],['ฝรั่งครึ่งผล','ผลไม้',55,2,12,0,'🍐'],['แตงโม 1 ชิ้น','ผลไม้',46,1,12,0,'🍉'],['มะละกอ 1 ถ้วย','ผลไม้',62,1,16,0,'🧡'],['สตรอว์เบอร์รี 1 ถ้วย','ผลไม้',49,1,12,0,'🍓'],['องุ่น 1 กำมือ','ผลไม้',104,1,27,0,'🍇'],['สับปะรด 1 ถ้วย','ผลไม้',82,1,22,0,'🍍'],['มะม่วงสุกครึ่งผล','ผลไม้',100,1,25,0,'🥭'],
 ['นมถั่วเหลืองไม่หวาน 1 แก้ว','นมและไข่',80,7,4,4,'🥛'],['กรีกโยเกิร์ต 1 ถ้วย','นมและไข่',130,15,9,3,'🥣'],['นมอัลมอนด์ไม่หวาน 1 แก้ว','นมและไข่',40,1,2,3,'🥛'],['ชีสไขมันต่ำ 1 แผ่น','นมและไข่',50,5,1,3,'🧀'],['เวย์โปรตีน 1 สกูป','นมและไข่',120,24,3,2,'🥤'],
 ['กะเพราอกไก่ + ข้าว','อาหารไทย',430,35,55,10,'🍛'],['ข้าวมันไก่ 1 จาน','อาหารไทย',585,28,75,18,'🍗'],['ส้มตำไทย','อาหารไทย',120,3,22,3,'🥗'],['ต้มยำกุ้ง 1 ถ้วย','อาหารไทย',145,18,10,4,'🍤'],['แกงจืดเต้าหู้หมูสับ 1 ถ้วย','อาหารไทย',180,19,8,8,'🍲'],['ผัดผักรวม 1 จาน','อาหารไทย',160,5,18,8,'🥦'],['ลาบไก่ 1 จาน','อาหารไทย',190,24,8,7,'🍗'],['ก๋วยเตี๋ยวน้ำใส 1 ชาม','อาหารไทย',300,16,48,6,'🍜'],['ข้าวราดแกง 2 อย่าง','อาหารไทย',550,22,70,18,'🍱'],
 ['น้ำเปล่า 1 แก้ว','เครื่องดื่ม',0,0,0,0,'💧'],['กาแฟดำไม่หวาน 1 แก้ว','เครื่องดื่ม',5,0,1,0,'☕'],['ชาเขียวไม่หวาน 1 แก้ว','เครื่องดื่ม',0,0,0,0,'🍵'],['น้ำมะพร้าว 1 ลูก','เครื่องดื่ม',90,1,22,0,'🥥'],['น้ำส้มคั้น 1 แก้ว','เครื่องดื่ม',112,2,26,0,'🧃']
].forEach((item,index)=>foods.push({id:foods.length+1,name:item[0],category:item[1],cal:item[2],protein:item[3],carbs:item[4],fat:item[5],emoji:item[6]}));
let foodCategory='ทั้งหมด',foodQuery='';
nutrition=function(){
  const meals=state.meals.filter(m=>m.date===today()),total=meals.reduce((n,m)=>n+m.cal,0),protein=meals.reduce((n,m)=>n+m.protein,0),carbs=meals.reduce((n,m)=>n+m.carbs,0),fat=meals.reduce((n,m)=>n+m.fat,0);
  const visible=foods.filter(food=>(foodCategory==='ทั้งหมด'||food.category===foodCategory)&&food.name.toLowerCase().includes(foodQuery.toLowerCase()));
  return `${header('FOOD LIBRARY','คลังอาหาร','แตะเพิ่มเพื่อบันทึกอาหาร 1 หน่วยบริโภค และติดตามพลังงานของวันนี้')}<div class="grid stats food-stats"><div class="stat"><div class="stat-icon">◉</div><div class="value">${total}</div><div class="label">พลังงาน · kcal</div></div><div class="stat"><div class="stat-icon">⚡</div><div class="value">${state.goal}</div><div class="label">เป้าหมายต่อวัน</div></div><div class="stat"><div class="stat-icon">✦</div><div class="value">${protein}g</div><div class="label">โปรตีน</div></div><div class="stat"><div class="stat-icon">◒</div><div class="value">${carbs}g</div><div class="label">คาร์บ · ไขมัน ${fat}g</div></div></div><div class="panel" style="margin-top:17px"><div class="section-head"><h2>ความคืบหน้าพลังงาน</h2><span class="meta">${Math.round(total/state.goal*100)}%</span></div><div class="bar"><span style="width:${Math.min(100,total/state.goal*100)}%"></span></div></div><section class="section"><div class="toolbar food-toolbar"><input class="input search" id="food-search" placeholder="⌕ ค้นหาอาหาร เช่น อกไก่ ข้าว กล้วย" value="${esc(foodQuery)}"><span class="meta">${visible.length} รายการ</span></div><div class="chips food-categories">${foodCategories.map(category=>`<button class="chip ${foodCategory===category?'active':''}" data-food-category="${category}">${category}</button>`).join('')}</div><div class="grid food-grid food-library">${visible.length?visible.map(food=>`<div class="card food-row"><span class="food-icon">${food.emoji}</span><div class="grow"><strong>${esc(food.name)}</strong><small>${food.cal} kcal · โปรตีน ${food.protein}g · คาร์บ ${food.carbs}g · ไขมัน ${food.fat}g</small></div><button data-food="${food.id}" aria-label="เพิ่ม ${esc(food.name)}">＋</button></div>`).join(''):'<div class="empty">ไม่พบอาหารที่ตรงกับการค้นหา</div>'}</div></section><section class="section"><div class="section-head"><h2>อาหารที่บันทึกวันนี้</h2><span class="meta">${meals.length} รายการ</span></div><div class="list">${meals.length?meals.map(m=>`<div class="list-item"><span>${m.emoji}</span><div class="grow"><strong>${esc(m.name)}</strong><small>${m.cal} kcal · โปรตีน ${m.protein}g · คาร์บ ${m.carbs}g</small></div><button data-remove-meal="${m.logId}">ลบ</button></div>`).join(''):'<div class="empty">ยังไม่มีอาหารที่บันทึกวันนี้</div>'}</div></section>`;
};
